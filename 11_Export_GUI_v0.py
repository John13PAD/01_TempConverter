...
class Export:
    def __init__(self, partner):
        ...
        #If users press x button for the export box, you cant access it again so this fixes it
        ...
        self.export_text = Label(self.export_frame, text="Enter a filename "
                                                                                                    ...
                                                                                                    "and press Save"
                                                                                                    "button to save your"
                                                                                                    "your caculation history"
                                                                                                    "to a text file",
                               justify=LEFT, width=40, bg=background, wrap=250)
        self.export_text.grid(row=1)
        
        #Warning text (Label, row 2)
        self.export_text = Label(sef.export_frame, text="if the filename"
                                                                                                    "you enter below"
                                                                                                    "already exists,"
                                                                                                    "its contents will"
                                                                                                    "be replaced with"
        ...
        sef.cancel_button.grid(row=0, column=1)
        
    
    def close_export(self, partner):
        #Put export button to normal...
